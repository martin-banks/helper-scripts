...
# We need this line to use newest version of got; not the version packaged with xcode
export PATH="/usr/local/bin:/usr/bin/git:/usr/bin:/usr/local/sbin:$PATH"

# Path to your oh-my-zsh installation.
export ZSH=/Users/banksm/.oh-my-zsh
...
alias cleanjson="node ~/PROJECTS_GITHUB/_helper-scripts/json-cleaner.js $1"
